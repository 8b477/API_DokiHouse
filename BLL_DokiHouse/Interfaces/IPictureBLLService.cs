...
namespace BLL_DokiHouse.Interfaces
{
    public interface IPictureBLLService
    {
        ...
        /// <summary>
        /// Ajoute une image de profil pour un utilisateur et met à jour la table User avec l'identifiant de l'image.
        /// </summary>
        /// <param name="idUser">Identifiant de l'utilisateur associé à l'image de profil.</param>
        /// <param name="file">Fichier image à associer au profil.</param>
        /// <returns>Identifiant de l'image de profil ajoutée.</returns>
